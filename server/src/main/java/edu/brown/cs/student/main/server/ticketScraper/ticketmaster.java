...
public class ticketmaster implements scraper {
    ...
    public Ticket best(String query) {
        ...
        Document doc = null;
        try {
            doc = Jsoup.connect(link).referrer("https://www.ticketmaster.com/").userAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36").get();
        } catch (IOException e){
